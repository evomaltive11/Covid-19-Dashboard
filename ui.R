...
ui <- fluidPage(theme = shinytheme("journal"),
  ...
  navbarPage(title = div("COVID-19 Dashboard", style = "padding-left: 10px"),
    ...
    navbarMenu("More", icon = icon("question-circle"),
               tabPanel(tags$a("", href = "https://github.com/evomaltive11/Covid-19-Dashboard/", target = "_blank",list(icon("github"), "Resources"))),
               tabPanel(tags$a("", href = "https://www.linkedin.com/in/nicholas-andrian-374635159/", target = "_blank",list(icon("linkedin"), "My Profile"))),
